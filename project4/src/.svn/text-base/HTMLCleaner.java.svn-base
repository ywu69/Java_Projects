...
public class HTMLCleaner
{
	...
	/*
	 * Parses the provided base url for HTML link into InvertedIndex and return the links found on the base url
	 * step:
	 * 1. get HTML source text by HTMLFether
	 * 2. get all links found on the base url
	 * 3. clean the html elements
	 * 4. populate an inverted index from the resulting text
	 * 5. return all links found on the base url
	 */
